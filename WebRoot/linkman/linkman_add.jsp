...
<BODY>
	...
	<FORM id=form1 name=form1
		...
		<TABLE cellSpacing="0" cellPadding="5" class="iTable">
			<tr>
				...
				<td style="width:300px; text-align:left;">
					...
					<input type="text" id="custName"  style="WIDTH: 150px"  value="" disabled placeholder="请选择" />
		...
		<div style="border:1px red solid; margin:10px 500px; width:150px; height:40px; ">
			<INPUT style="width:150px; height:40px;font-size:20px; " class="button" type="submit" value="保存 " name=sButton2>
		</div>
