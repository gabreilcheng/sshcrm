					...
					<TR>
						<TD height=25>
							<TABLE cellSpacing=0 cellPadding=2 border=0>
								<form id="customerForm" name="customerForm" action="${pageContext.request.contextPath }/role_pageList.action"
									method="post">
									<TBODY>
										<!-- 隐藏域，当前页码  -->
										...
										<TR>
											<TD>角色名称：</TD>
											<TD>
												<INPUT class=textbox id=sChannel2 value="${param.role_name}" style="width: 160px;height:25px; font-size:20px; text-indent:5px;" maxLength=50 name="role_name" />
											</TD>
											<TD>
						...
						<TD>
							<TABLE id=grid
								...
								<TBODY>
									...
									<s:iterator value="#pageBean.list" var="role" status="id">
										<TR
											style="FONT-WEIGHT: normal; FONT-STYLE: normal; BACKGROUND-COLOR: white; TEXT-DECORATION: none">
											<TD><s:property value="#role.role_name"/></TD>
											<TD><s:property value="#code[#id.index]" /></TD>
											<TD><s:property value="#role.role_memo"/></TD>
											<%-- <TD><s:property value="#session.user.user_name" /></TD> --%>
											<TD>
											<%-- <a style="font-size:18px;" href="${pageContext.request.contextPath }/role_edit?role_id=<s:property value="#role.role_id"/>">修改</a> --%>
											<!-- &nbsp;&nbsp; -->
											<a style="font-size:18px;"  href="${pageContext.request.contextPath }/role_delRole?role_id=<s:property value="#role.role_id"/>">删除</a>
											</TD>
										</TR>
									</s:iterator>
								</TBODY>
